  ...
  render() {
      return (
        <div>
          ...
          <input  type="text" placeholder="訪問先" ref="keyword" />
          <input  type="text" placeholder="利用路線" ref="keyword" />
          <input  type="text" placeholder="出発" ref="keyword" />
          <input  type="text" placeholder="到着" ref="keyword" />
          <input  type="text" placeholder="片道金額" ref="keyword" />
          <input  type="radio"  value="片道" />片道
          <input  type="radio"  value="往復" />往復
